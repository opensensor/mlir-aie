...
from .sparse import SparseFifo  # T2.5: real impl replaces stub below
...
# T2.5 (LANDED): SparseFifo reservation slot replaced by real implementation
# imported above (``from .sparse import SparseFifo``). See ``python/iron/sparse.py``
# for the class body and AM020 N:M decompression cross-walk.
...
# See ``python/iron/memtile.py`` for the class body and the canonical
